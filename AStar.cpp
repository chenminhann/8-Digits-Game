...
*/
const int N=2E6+10;int n; int k=1;                 //只有362880种状态，每种状态最多可以向4个方向转移,4*362880=1,451,520，N为2E6则可。
//Part 1:-----------------------------------------//A*算法计算单源最短路
